...
class Client {
	...
	public static function wpcom_json_api_request_as_user(
		...
		$args            = validate_args_for_wpcom_json_api_request( $path, $version, $args, $base_api_path );
	...
	public static function wpcom_json_api_request_as_blog(
		...
		$validated_args            = validate_args_for_wpcom_json_api_request( $path, $version, $args, $base_api_path );
